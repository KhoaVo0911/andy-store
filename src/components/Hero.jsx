  ...
  return (
   <>
      <div className='relative h-auto w-auto flex flex-col'>
        <div 
        className=' clip-path h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 right-0 opacity-100 z-10'
        style={{
        ...
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
          ...
          <div className='flex items-center'>
            <img
              src={img}
              alt='hero-img/img'
              className='w-auto h-[50vh] t-0 lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transitions-theme cursor-pointer object-fill'
            />
          </div>
        </div>
      </div>
